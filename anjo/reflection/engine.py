...
{transcript_text}"""
    ...
    # Time-based decay is handled exclusively by apply_daily_drift (drift.py).
    # Running it here too caused mood to decay twice for active daily users.
    ...
    if not mid_session:
        ...
        # Only ask "should I cross the ceiling?" when the relationship actually
